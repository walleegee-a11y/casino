...
if { ${ovars(lec_fm,is_flatten)} == "0" } {
    ...
    set implementation [list \
        ...
        ${OUTFEED_PATH}/fb_left/pd___${db_ver}/$ovars(lec_fm,sub_block_version,fb_left)/netlist/fb_left.v \
    ]
...
# Set constant
##################################################
if { ${top_design} == "ANA6716" && $ovars(lec_fm,is_flatten) == 1 } {
...
} elseif { ${top_design} == "fb_right" } {
    set_constant -type port r:/WORK/fb_right/scan_en 0
    set_constant -type port i:/WORK/fb_right/scan_en 0
	source -e -v /mnt/data/prjs/ANA6716/works_rachel.han/fb_right/constant/set_constant_at_scan_lockup_latch_right.tcl
} elseif { ${top_design} == "fb_left" } {
    set_constant -type port r:/WORK/fb_left/scan_en 0
    set_constant -type port i:/WORK/fb_left/scan_en 0
	source -e -v /mnt/data/prjs/ANA6716/works_rachel.han/fb_left/constant/set_constant_at_scan_lockup_latch_left.tcl
} else {
    puts "INFO: no set_constant rule for $top_design"
}
