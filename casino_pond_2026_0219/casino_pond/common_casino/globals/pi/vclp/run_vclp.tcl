...
###		set UPF ${DB_PATH}/vers/${db_ver}/design/upf/${top_design}.upf
    ...
    if { [info exists ovars(vclp,is_flatten)] && $ovars(vclp,is_flatten) == 1 } {
		# Except TOP netlist
...
if { [llength $NETLIST] > 0 } {
    ...
    echo "current_design $top_design"
    current_design $top_design

    echo "link_design $top_design"
	...
	checkpoint_session -session ${top_design}.link.session
