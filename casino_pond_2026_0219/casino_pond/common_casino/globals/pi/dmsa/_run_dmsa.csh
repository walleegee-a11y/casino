#! /bin/csh -f
setenv SYNOPSYS_LC_ROOT "/mnt/appl/Tools_2024/synopsys/lc/S-2021.06-SP4P" ;# TODO
###############################################
...
setenv RUN_COMMON_DMSA    ${PRJ_HOME}/works_${USER}/${top_design}/${ws}/runs/${run_ver}/common/globals/pi/dmsa
...
\cp ${RUN_COMMON_DMSA}/run_dmsa.tcl ${dmsa_dir}
