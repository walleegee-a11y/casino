    ...
    if ("$CURRENT_DIR" =~ *runs\/*\/*$stage*) then
        ...
        switch ($vendor)
            ...
            case Cadence:
                ...
                #setenv CDS_INNOVUS211 /mnt/appl/Tools_2024/cadence/INNOVUS/INNOVUS211/tools.lnx86
				setenv CDS_INNOVUS221 /mnt/appl/Tools_GW/cadence/DDI_22.13.000/INNOVUS221/tools.lnx86
                setenv CDS_GENUS /mnt/appl/Tools_2024/cadence/GENUS/GENUS201/tools.lnx86
                ...
                setenv PATH "${CDS_CONFRMAL}/bin:${CDS_INNOVUS221}/bin:${CDS_GENUS}/bin:${CDS_PVS}/bin:${CDS_SPECTRE}/bin:${CDS_VOLTUS}/bin:$PATH"
                breaksw
            ...
            case Synopsys:
                ...
                setenv VC_STATIC_HOME /mnt/appl/Tools_2024/synopsys/vc_static/S-2021.09-SP1P
                setenv PATH "${VC_STATIC_HOME}/bin:${SYN_DC}/bin:${SYN_FORMALITY}/bin:${SYN_ICC2}/bin:${SYN_PT}/bin:${SYN_STARRCXT}/bin:${SYN_TMAX}/bin:${SYN_LC}/bin:${SYN_TESTMAX}/bin:${SYN_VERDI}/bin:$PATH"
                breaksw
