...
proc user_cell_usage {} {
	...
	# Vth
	set RVT_PATTERN  "PD"
	set LVT_PATTERN  "PDLVT"
	set ULVT_PATTERN "PDULVT"
	...
	set STD_TOTAL_NUM   [expr $NUM_RVT + $NUM_LVT + $NUM_ULVT]
	set STD_TOTAL_AREA  [expr $AREA_RVT + $AREA_LVT + $AREA_ULVT]
	set STD_TOTAL_GC    [format %.0f [expr $GC_RVT + $GC_LVT + $GC_ULVT]]
	...
	set STD_TOTAL_RATIO [format %.2f [expr $RATIO_RVT + $RATIO_LVT + $RATIO_ULVT]]
	...
	puts $fout "======================"
	puts $fout " RVT   : LVT   : ULVT"
	puts $fout " [format %.2f $RATIO_RVT] : [format %.2f $RATIO_LVT] : [format %.2f $RATIO_ULVT]"
	puts $fout "======================"
	puts $fout ""
