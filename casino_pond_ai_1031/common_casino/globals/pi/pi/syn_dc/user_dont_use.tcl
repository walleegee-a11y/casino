set fin [open ./dont_use.tcl w] 
set a   [open ./user_dont_use.list w]
...
foreach_in_collection cell $all_cells {
    ...
    if { $num_of_input_pins >= 5 } {
        puts $a "Setting dont_use for cell: $lib_cell_name with $num_of_input_pins input pins"
        puts $fin "set_dont_use $lib_cell_name"
    }
}
