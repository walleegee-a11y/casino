...
create_constraint_mode -name func    -sdc_files "${sdc_path}/temp.sdc"
create_constraint_mode -name shift   -sdc_files "${sdc_path}/temp.sdc"
create_constraint_mode -name capture -sdc_files "${sdc_path}/temp.sdc"
